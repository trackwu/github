...
public class DLProxyImpl {
    ...
    public boolean initEnv(Intent intent) {
    ...
    protected void launchTargetActivity(Bundle savedInstanceState) {
        try {
    ...
    public void onRecoverInstanceState(Bundle savedInstanceState, Intent intent) {
        intent.putExtra(DLConstants.EXTRA_PACKAGE, savedInstanceState.getString(DLConstants.EXTRA_PACKAGE));
        intent.putExtra(DLConstants.EXTRA_CLASS, savedInstanceState.getString(DLConstants.EXTRA_CLASS));
    }

    public void onSaveInstanceState(Bundle outState) {
        outState.putString(DLConstants.EXTRA_PACKAGE, mPackageName);
        outState.putString(DLConstants.EXTRA_CLASS, mClass);
    }
